...
import org.albedu.oauth2.ui.tasks.TestIMAPAuthenticationTask;
import org.apache.log4j.Logger;

public class TestIMAPAuthenticationPanel extends JPanel implements DocumentListener, ActionListener, BackgroundTaskListener {
	...
	public TestIMAPAuthenticationPanel() {
		setLayout(null);
		...
		this.btnContinue = new JButton("Test IMAP Authentication");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource().equals(this.btnContinue)) {
			...
			TestIMAPAuthenticationTask testIMAPAuthenticationTask = new TestIMAPAuthenticationTask(this, user, accessToken);
			testIMAPAuthenticationTask.execute();
		}
	}

	@Override
	public void updateUI(Object source, Object output) {
		if (source instanceof TestIMAPAuthenticationTask) {
