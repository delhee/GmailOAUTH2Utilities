...
public class GmailOAUTH2UITool extends JFrame implements ListSelectionListener {
	...
	private GmailOAUTH2UITool() throws IOException {
		...
		String features[] = { "Refresh Token", "Generate OAUTH2 String", "Generate OAUTH2 Token", "Test IMAP Auth", "Test SMTP Auth", "Convert Base64 String to Text" };
	...
	private void loadPreviouslyInputData() {
		...
		//this.genOAUTH2TokenPanelVerificationCode = this.savedInputData.getProperty(Constant.KEY_GEN_OAUTH2_TOKEN_PANEL_VERIFICATION_CODE);
	...
	private void saveUserInput() {
		...
		if (this.mGenerateOAUTH2TokenPanel != null) {
			...
			//this.savedInputData.setProperty(Constant.KEY_GEN_OAUTH2_TOKEN_PANEL_VERIFICATION_CODE, this.mGenerateOAUTH2TokenPanel.getAuthorizationCode());
			...
			if (arg0.getSource().equals(this.featureList.getJList())) {
				...
				case 5:
					if (this.mBase64ToTextPanel == null) {
						...
						this.mBase64ToTextPanel.setTaBase64String(this.base64ToTextPanelBase64String);
					}
